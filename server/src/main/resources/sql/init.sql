...
(
    id                varchar(64) not null comment '主键唯一id',
    name              varchar(255) default null comment '名称',
    rel_type          varchar(20)  default null comment '关系类别',
    rel_property      varchar(255)  default null comment '关系属性',
    start_entity_id   varchar(64)  default null comment '开始节点id',
    start_entity_name varchar(255) default null comment '开始节点名称',
    start_property1   varchar(255) default null comment '开始节点属性1（身份证号）',
    start_property2   varchar(255) default null comment '开始节点属性2（家庭地址）',
    end_entity_id     varchar(64)  default null comment '结束节点id',
    end_entity_name   varchar(64)  default null comment '结束节点名称',
    end_property1     varchar(255) default null comment '结束节点属性1（身份证号）',
    end_property2     varchar(255) default null comment '结束节点属性2（家庭地址）',
